...
# les paramètres spécifiques au dataset FATIG
SEED = 2023
BATCH_SIZE = 64
EPOCHS = 200
LEARNING_RATE = 1e-3
...
SAVE_PATH = './save/my_logs_FATIG_Deformer/'
...
def train():
    ...
    for test_id in sorted(all_data):
        ...
        model = EEGDeformer(in_channels=30, seq_len=384, num_classes=3, dropout=DROPOUT).to(DEVICE)
